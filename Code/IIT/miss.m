...
datapath = "/d/aveyrie/Documents/epochs_miss_around_detection/125Hz/"
addpath(genpath(toolboxpath));
addpath(genpath(npymatlabpath));
addpath(genpath(datapath));

epoch = readNPY(datapath + "epochs_miss_around_detection_values_sujet_xx.npy");
...
csvwrite('phi_measures_mean_over_trials_miss_sujet_xx.csv', phi)
...
%save('/d/aveyrie/Documents/MATLAB/phi_measures_mean_over_trials_miss_sujet_xx.png')
